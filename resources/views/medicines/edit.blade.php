            ...
            <div class="grid gap-6">
                ...
                <div class="space-y-2">
                    ...
                    <x-input-with-icon-wrapper>
                        ...
                        <x-input withicon id="name" class="@error('name') is-invalid @enderror block w-full" type="text" name="name" :value="$medicine->name"
                ...
                <div class="space-y-2">
                    <fieldset class="flex">
                        ...
                        <div class="flex items-center mt-4">
                          <input {{$medicine->unit == 'Buah' ? 'checked' : ''}} required id="unit-option-1" type="radio" name="unit" value="Buah" class="w-4 h-4 border-gray-300 focus:ring-2 focus:ring-blue-300 dark:focus:ring-blue-600 dark:focus:bg-blue-600 dark:bg-gray-700 dark:border-gray-600" aria-labelledby="unit-option-1" aria-describedby="unit-option-1"  >
                        ...
                        <div class="flex items-center ml-5 mt-4 ">
                          <input {{$medicine->unit == 'Botol' ? 'checked' : ''}} required id="unit-option-2" type="radio" name="unit" value="Botol" class="w-4 h-4 border-gray-300 focus:ring-2 focus:ring-blue-300 dark:focus:ring-blue-600 dark:focus:bg-blue-600 dark:bg-gray-700 dark:border-gray-600" aria-labelledby="unit-option-2" aria-describedby="unit-option-2">
                        ...
                        <div class="flex items-center ml-5 mt-4 ">
                            <input {{$medicine->unit == 'Strip' ? 'checked' : ''}} required id="unit-option-3" type="radio" name="unit" value="Strip" class="w-4 h-4 border-gray-300 focus:ring-2 focus:ring-blue-300 dark:focus:ring-blue-600 dark:focus:bg-blue-600 dark:bg-gray-700 dark:border-gray-600" aria-labelledby="unit-option-3" aria-describedby="unit-option-3">
                        ...
                        <div class="flex items-center ml-5 mt-4 ">
                            <input {{$medicine->unit == 'Bungkus' ? 'checked' : ''}} required id="unit-option-4" type="radio" name="unit" value="Bungkus" class="w-4 h-4 border-gray-300 focus:ring-2 focus:ring-blue-300 dark:focus:ring-blue-600 dark:focus:bg-blue-600 dark:bg-gray-700 dark:border-gray-600" aria-labelledby="unit-option-4" aria-describedby="unit-option-4">
                ...
                <div class="space-y-2">
                    ...
                    <x-input-with-icon-wrapper>
                        ...
                        <x-input withicon id="stock" class="@error('stock') is-invalid @enderror block w-full" type="number" name="stock" :value="$medicine->stock"
                 ...
                 <div class="space-y-2">
                    ...
                    <x-input-with-icon-wrapper>
                        ...
                        <x-input withicon id="price" class="@error('price') is-invalid @enderror block w-full" type="number" name="price" :value="$medicine->price"
