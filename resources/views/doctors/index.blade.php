<x-app-layout>
    ...
    <x-slot name="header">
        ...
        <a href="{{route('doctors.create')}}" type="button" class=" flex bg-purple-500 text-white hover:bg-purple-600 focus:ring-purple-500 px-2.5 py-1.5 text-sm rounded" >
                ...
                <tbody>
                    @forelse ($doctors as $key => $doctor)
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                            ...
                            <form id="delete-form" action="{{ route('doctors.delete', $doctor->id) }}" method="POST" style="display: none;">
                                @method('delete')
                                @csrf
                            </form>
                        </tr>                
